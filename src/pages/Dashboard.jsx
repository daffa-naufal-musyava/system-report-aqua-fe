...
import { useMachine } from '../context/MachineProvider';

export default function Dashboard() {
  const { trendData, loading, fetchTrendData } = useMachine();
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <DashboardCard 
            ...
            isNegative={true}
            icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6"><path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m9-.75a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 3.75h.008v.008H12v-.008Z" /></svg>}
          />
          ...
          <div className="relative h-1/2">
              ...
              <div className="flex items-center gap-3">
                <div className="relative">
                  <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M14 3C14 3 8 6 8 14V20H20V14C20 6 14 3 14 3Z" stroke="#f97316" strokeWidth="1.8" strokeLinejoin="round" fill="none"/>
                    <path d="M11 20C11 21.657 12.343 23 14 23C15.657 23 17 21.657 17 20" stroke="#f97316" strokeWidth="1.5" fill="none"/>
                  </svg>
                </div>
            ...
            {showNotifications && (
              <div className="absolute top-full right-0 mt-2 w-64 bg-[#1e293b] border border-slate-700/50 rounded-xl shadow-2xl z-50 overflow-hidden">
                <div className="px-4 py-2.5 text-[10px] font-black text-slate-500 border-b border-slate-700/50 uppercase tracking-widest">Recent Alerts</div>
                <div className="px-4 py-3 text-[11px] text-slate-300 hover:bg-slate-700/40 cursor-pointer italic">Line 2: Motor temperature high (85°C)</div>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          {loading && trendData.length === 0 ? (
            <div className="text-center py-10 text-slate-500 animate-pulse">Fetching Real-time Data...</div>
          ) : (
            trendData.map(line => (
