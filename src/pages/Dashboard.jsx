         ...
         <div className="relative h-1/2">
            ...
            >
              <div className="flex items-center gap-3">
                {/* Bell icon dengan warning triangle, mirip gambar */}
                <div className="relative">
                  <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M8 20H20" stroke="#f97316" strokeWidth="1.8" strokeLinecap="round"/>
                    <circle cx="14" cy="23" r="1.5" fill="#f97316"/>
                    <path d="M14 9L14 15" stroke="#f97316" strokeWidth="1.8" strokeLinecap="round"/>
                    <circle cx="14" cy="17" r="0.8" fill="#f97316"/>
                    {/* Bell shape hint */}
              ...
              <svg
                ...
                className={`text-slate-400 transition-transform duration-200 ${showNotifications ? 'rotate-180' : ''}`}
              >
            ...
            {showNotifications && (
              <div className="absolute top-full right-0 mt-2 w-64 bg-[#1e293b] border border-slate-700/50 rounded-xl shadow-2xl z-50 overflow-hidden">
                ...
                <div className="px-4 py-3 text-[11px] text-slate-300 hover:bg-slate-700/40 cursor-pointer border-b border-slate-800 transition-colors italic">
                  Line 2: Motor temperature high (85°C)
                </div>
                <div className="px-4 py-2.5 text-center text-cyan-400 text-[10px] font-bold cursor-pointer hover:underline tracking-wider uppercase">
                  Mark All as Read
                </div>
              </div>
            )}
