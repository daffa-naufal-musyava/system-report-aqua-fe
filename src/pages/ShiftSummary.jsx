...
export default function ShiftSummary() {
  ...
  useEffect(() => {
    fetchAllData();
    const pollInterval = setInterval(() => fetchAllData(true), 5000);
  ...
  const handlePdtChange = (shiftIdx, hourIdx, value) => {
    ...
    updated[shiftIdx][hourIdx] = numVal;
    setManualPdt(updated);
  };

  const getPdtShiftTotal = (shiftIdx) => manualPdt[shiftIdx].reduce((a, b) => a + b, 0);
  ...
  return (
    <div className="min-h-screen bg-[#05070a] text-white p-4 font-sans flex flex-col lg:flex-row gap-6 overflow-x-hidden">
      ...
      <div className="w-full lg:w-[450px] flex flex-col items-end">
        ...
        <div className="w-full border mt-57 border-slate-700 bg-black/40 shadow-2xl rounded-lg overflow-hidden">
          <table className="w-full text-[12px] border-collapse font-bold">
            ...
            <tbody>
              ...
              {/* PDT DAILY - SYNC DENGAN MANUAL INPUT */}
